...
export GITOPS_REPO_URL=https://github.com/xjiangorg/stqebno5d-dotnet-basic-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.rosa.xjiang0227417.hbmn.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.rosa.xjiang0227417.hbmn.p3.openshiftapps.com}
